...
#    url(r'^mappings/$', 'editor.app.views.mappings', name='mappings'),
    url(r'^invalid_mappings/$', 'editor.app.views.invalid_mappings', name='invalid_mappings'),
...
#    url(r'^new_mapping/$', 'editor.app.views.new_mapping', name='new_mapping'),
    ...
    url(r'^mappingformats/$', 'editor.app.views.mapping_formats', name='mapping_formats'),
    url(r'^mappingconcepts/$', 'editor.app.views.mapping_concepts', name='mapping_concepts'),
    url(r'^definevalue/(?P<fformat>[^/]+)/$', 'editor.app.views.define_value', name='define_value'),
    url(r'^defineconcept/(?P<fformat>[^/]+)/$', 'editor.app.views.define_concept', name='define_concept'),
    url(r'valuemap/$', 'editor.app.views.value_maps', name='value_maps'),
    url(r'definevaluemap', 'editor.app.views.define_valuemap', name='define_valuemaps'),
