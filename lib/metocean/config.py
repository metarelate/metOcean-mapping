...
"""
Provides support for site configuration of metOcean.
...
# MetOcean configuration file sections.
_SECTION_FUSEKI = 'fuseki'
_SECTION_RESOURCE = 'resource'
_SECTION_SYSTEM = 'system'

# MetOcean configuration option defaults.
...
def _get_dir_option(parser, section, option, default=None):
    ...
    if parser.has_option(section, option):
        ...
        if os.path.isdir(value):
            ...
            msg = 'MetOcean Configuration - Invalid section {!r}, ' \
...
def update(config):
    ...
    if os.path.isdir(config_dir):
        ...
        if os.path.isfile(config_file):
            ...
            if result is None:
                msg = 'MetOcean Configuration - Missing Apache Jena ' \
            ...
            result = _get_dir_option(parser, _SECTION_SYSTEM, option)
            if result is None:
                msg = 'MetOcean Configuration - Missing Apache ' \
            ...
            if result is None:
                msg = 'MetOcean Configuration - Missing static data ' \
            ...
            result = _get_dir_option(parser, _SECTION_RESOURCE, option)
            if result is None:
                msg = 'MetOcean Configuration - Missing test static data ' \
            ...
            result = _get_dir_option(parser, _SECTION_RESOURCE, option)
            if result is None:
                msg = 'MetOcean Configuration - Missing Apache Jena test ' \
                    'triple store database directory. ' \
                    'Section {!r}, option {!r}.'
                warnings.warn(msg.format(_SECTION_RESOURCE, option))
            else:
            ...
            try:
                ...
                msg = 'MetOcean Configuration - Ignoring invalid port for ' \
            ...
            try:
                ...
                msg = 'MetOcean Configuration - Ignoring invalid test port ' \
            ...
            try:
                ...
                msg = 'MetOcean Configuration - Ignoring invalid timeout ' \
            ...
            msg = 'MetOcean Configuration - Missing configuration file {!r}'
            warnings.warn(msg.format(config_file))
    else:
        msg = 'MetOcean Configuration - Missing configuration directory {!r}'
