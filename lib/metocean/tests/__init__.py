...
"""
Provides unit test support specific to metOcean.
...
class MetOceanTestCase(unittest.TestCase):
    """
    A subclass of :class:`unittest.TestCase` which provides metOcean
    ...
    def check_dot(self, mapping):
        ...
        Args:
        * mapping: The :class:`metocean.Mapping` to be compared.
